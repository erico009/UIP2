                        ...
                        <form class="needs-validation" novalidate>
                            ...
                            <div class="row">
                                <div class="col-md-5 mb-3">
                                    ...
                                    <select class="custom-select d-block w-100" id="store" required>
                                        <option value="">Choose...</option>
                                        <option>This is the only store</option>
                                    </select>
                                    <div class="invalid-feedback">
                            ...
                            <div class="custom-control custom-checkbox">
                                <input type="radio" name="ordertype" class="custom-control-input" id="pickup" />
                                <label class="custom-control-label" for="same-address">Pickup</label>
                            </div>
                            <div class="custom-control custom-checkbox">
                                <input type="radio" name="ordertype" class="custom-control-input" id="delivery" />
                                <label class="custom-control-label" for="save-info">Delivery</label>
                            </div>
